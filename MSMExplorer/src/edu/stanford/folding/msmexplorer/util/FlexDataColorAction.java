...
/**
 * Another unnecessary copy of a class because members that should be
 * settable were not. Enables setting of palette on the fly.
 * @author brycecr
 * 
 * <p>
 ...
 * client-specified palette provided to the FlexDataColorAction constructor.
 * </p>
 * 
 * <p>
 ...
 */
public class FlexDataColorAction extends ColorAction {
    ...
    /**
     * Create a new FlexDataColorAction
     ...
     */
    public FlexDataColorAction(String group, String dataField, 
    ...
    /**
     * This operation is not supported by the FlexDataColorAction type.
...
} // end of class FlexDataColorAction
